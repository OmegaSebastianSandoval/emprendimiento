                ...
                <div class="col-md-5">
                    <div class="caja-imagen-tienda"
                        ...
                        <div class="caja-tienda2">
                            ...
                            <img class="px-4" src="/images/<?php echo $this->tienda->tiendas_imagen ?>" alt="">
                    ...
                    <div class="caja-tienda-texto p-4">
                        ...
                        <div class="datos-tienda py-3">
                            <?php if ($this->tienda->tiendas_pagina != "") { ?>
                                        <span><a href="http://<?php echo enlacepagina($this->tienda->tiendas_pagina) ?>" target="_blank"><?php echo $this->tienda->tiendas_pagina ?></a></span><br>
                            <?php } ?>
                            <?php if ($this->tienda->tiendas_facebook != "") { ?>
                                        <span><a href="https://www.facebook.com/<?php echo enlaceredes($this->tienda->tiendas_facebook) ?>" target="_blank">facebook/<?php echo enlaceredes($this->tienda->tiendas_facebook) ?></a></span><br>
                            <?php } ?>
                            <?php if ($this->tienda->tiendas_instagram != "") { ?>
                                        <span>Instagram: <a href="https://www.instagram.com/<?php echo enlaceredes($this->tienda->tiendas_instagram) ?>" target="_blank">@<?php echo enlaceredes($this->tienda->tiendas_instagram) ?></a></span><br>
                            <?php } ?>
                            <?php if ($this->tienda->tiendas_telefono != "") { ?>
                                        <?php $telefono = intval(preg_replace('/[^0-9]+/', '', $this->tienda->tiendas_telefono), 10); ?>
                                        <span>Teléfono:<a href="tel:<?php echo $telefono ?>" target="_blank"> <?php echo $this->tienda->tiendas_telefono ?></a></span>
                            <?php } ?>
                        </div>
                        <div class="whatsapp-tienda">
                            ...
                            <?php } else if ($this->tienda->tiendas_facebook != "") { ?>
                                                <a class="btn-whatsapp2"
                                                    style="background-color:<?php echo $this->categorias->categorias_color ?>"
                                                    href="https://www.facebook.com/<?php echo enlaceredes($this->tienda->tiendas_facebook) ?>" target="_blank">
                                                    <span>Contactar via facebook</span>
                                                </a>
                            <?php } else if ($this->tienda->tiendas_instagram != "") { ?>
                                                        <a class="btn-whatsapp2"
                                                            style="background-color:<?php echo $this->categorias->categorias_color ?>"
                                                            href="https://www.instagram.com/<?php echo enlaceredes($this->tienda->tiendas_instagram) ?>" target="_blank">
                ...
                <?php foreach ($this->productos as $key => $producto) { ?>
                            <div class="col-md-4 pt-4">
                                <div class="caja-producto p-3">
                                    ...
                                    <div class="descripcion-producto mt-2">
