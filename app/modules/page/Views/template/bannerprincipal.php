        ...
        <div id="carouselprincipal<?php echo $this->seccionbanner;  ?>" class="carousel slide" data-bs-ride="carousel">
            <ol class="carousel-indicators">
                <?php foreach ($this->banners as $key => $banner) { ?>
                    <li data-target="#carouselprincipal<?php echo $this->seccionbanner;  ?>" data-bs-slide-to="<?php echo $key ?>" <?php if ($key == 0) { ?>class="active d-none" <?php }  ?>></li>
                <?php } ?>
            </ol>
            <div class="carousel-inner">
                <?php foreach ($this->banners as $key => $banner) { ?>

                    <div class="carousel-item <?php if ($key == 0) { ?>active <?php } ?>" <?php if ($banner->publicidad_enlace != "") { ?> style="cursor: pointer;" <?php } ?>>
                        ...
                        <?php } else { ?>
                            <?php if ($banner->publicidad_enlace != "") { ?><a style="cursor:pointer;" href="<?php echo $banner->publicidad_enlace ?>" <?php if ($banner->publicidad_tipo_enlace == 1) { ?> target="_blank" <?php } ?>><?php } ?>
