                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-2 form-group div_direccion">
                                        ...
                                        <select name="pedido_nomenclatura" id="pedido_nomenclatura" class="form-control form-control-sm" onchange="calcular_envio();" required>
                                            ...
                                            <option value="Avenida Calle" <?php if ($this->ultimo->pedido_nomenclatura == "Avenida Calle") {
                                                                                echo 'selected';
                                                                            } ?>>Avenida Calle</option>
                                            <option value="Avenida Carrera" <?php if ($this->ultimo->pedido_nomenclatura == "Avenida Carrera") {
                                                                                echo 'selected';
                                                                            } ?>>Avenida Carrera</option>
                                            <option value="Calle" <?php if ($this->ultimo->pedido_nomenclatura == "Calle") {
                                                                        echo 'selected';
                                                                    } ?>>Calle</option>
                                            <option value="Carrera" <?php if ($this->ultimo->pedido_nomenclatura == "Carrera") {
                                                                        echo 'selected';
                                                                    } ?>>Carrera</option>
                                            <option value="Diagonal" <?php if ($this->ultimo->pedido_nomenclatura == "Diagonal") {
                                                                            echo 'selected';
                                                                        } ?>>Diagonal</option>
                                            <option value="Transversal" <?php if ($this->ultimo->pedido_nomenclatura == "Transversal") {
                                                                            echo 'selected';
                                                                        } ?>>Transversal</option>
                                        </select>
                                    ...
                                    <div class="col-lg-10 form-group div_direccion">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-2">
                                                <input type="number" class="form-control form-control-sm" name="numero1" id="numero1" placeholder="número" onchange="calcular_envio();" onkeyup="calcular_envio();" min="1" value="<?php echo $this->ultimo->pedido_numero1; ?>" required>
                                                <div class="ejemplo">7</div>
                                            </div>
                                            <div class="col-lg-2">
                                                <input type="text" class="form-control form-control-sm" name="letra1" placeholder="letra" value="<?php echo $this->ultimo->pedido_letra1; ?>">
                                            ...
                                            <div class="col-lg-2">
                                                <input type="number" class="form-control form-control-sm" name="numero2" id="numero2" onchange="calcular_envio();" onkeyup="calcular_envio();" placeholder="número" min="1" value="<?php echo $this->ultimo->pedido_numero2; ?>" required>
                                                <div class="ejemplo">78</div>
                                            </div>
                                            <div class="col-lg-2">
                                                <input type="text" class="form-control form-control-sm" name="letra2" placeholder="letra" value="<?php echo $this->ultimo->pedido_letra2; ?>">
                                            ...
                                            <div class="col-lg-2">
                                                <input type="number" class="form-control form-control-sm" name="numero3" id="numero3" min="1" placeholder="número" value="<?php echo $this->ultimo->pedido_numero3; ?>" required>
                                                <div class="ejemplo">96</div>
                                            </div>
                                            <div class="col-lg-4">
                                                <textarea name="complemento" id="complemento" class="form-control form-control-sm" placeholder="complemento" onchange="calcular_envio();" onkeyup="calcular_envio();"><?php echo $this->ultimo->pedido_complemento; ?></textarea>
                                                <div class="ejemplo">Apartamento, casa, piso, interior, otros.</div>
                                            </div>
                                            <div class="col-lg-7">
                                                <textarea name="indicaciones" id="indicaciones" class="form-control form-control-sm" placeholder="indicaciones" onchange="calcular_envio();" onkeyup="calcular_envio();"><?php echo $this->ultimo->pedido_indicaciones; ?></textarea>
