                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-10 form-group div_direccion">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4">
                                                <input type="text" name="complemento" id="complemento" value="<?php echo $this->direccion ?>" class="form-control form-control-sm" placeholder="complemento" onchange="calcular_envio();" onkeyup="calcular_envio();">
                                                <div class="ejemplo">Apartamento, casa, piso, interior, otros.</div>
                                            </div>
                                            <div class="col-lg-7">
                                                <input type="text" name="indicaciones" id="indicaciones" value="<?php echo $this->direccion ?>" class="form-control form-control-sm" placeholder="Indicaciones" onchange="calcular_envio();" onkeyup="calcular_envio();">
                                    ...
                                    <div class="col-12">
                                        <div class="mensaje-autorizacion margen_politica">
                                            <div class="form-check" required>
                                                <input class="form-check-input" type="checkbox" id="gridCheck" required><a class="terminos" href="#ventana" data-toggle="modal"> Acepto términos y condiciones</a>
