            ...
            <div class="list-top-categorias">
                ...
                <div class="list-group list-categorias d-none d-md-block">
                    ...
                    <?php foreach ($this->categorias as $key => $categoria) { ?>
                        ...
                        <a type="button"
                            href="/page/categoria?id=<?php echo $categoria->categorias_id ?>&page=1&subtienda=<?= $this->tienda->tiendas_id ?>"
...
<script>
    ...
    function buscar_categoria_mobile() {
        ...
        if(id) {
            var url = '/page/categoria?id=' + id + '&page=1&subtienda=<?php echo $this->tienda->tiendas_id ?>';
