                ...
                <div class="list-group list-categorias">
                    ...
                    <?php foreach ($this->categorias as $key => $categoria) { ?>
                        ...
                        <a type="button" href="/page/categoria?id=<?php echo $categoria->categorias_id ?>&page=1"
                            class="list-group-item list-group-item-action  <?php echo $categoria->categorias_id == $this->categoria->categorias_id ? 'active' : '' ?>" aria-current="true">
                ...
                <div class="caja-producto p-3">
                    ...
                    <div class="caja-vermas-producto">
                        <span role="button" data-bs-target="#detalle-producto<?php echo $producto->productos_id ?>"
                            ...
                            style="color:<?php echo $this->categoria->categorias_color ?>; border:1px solid <?php echo $this->categoria->categorias_color ?>">Ver
                            más</span>
                    </div>
