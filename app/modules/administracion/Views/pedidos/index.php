			...
			<div class="row">
				...
				<div class="col-lg-3">
					...
					<label class="input-group">
						...
						<input type="text" class="form-control" name="pedido_fecha" value="<?php echo $this->getObjectVariable($this->filters, 'pedido_fecha') ?>"></input>
					</label>
				</div>
				<div class="col-lg-3">
					...
					<label class="input-group">
						...
						<input type="text" class="form-control" name="pedido_valorpagar" value="<?php echo $this->getObjectVariable($this->filters, 'pedido_valorpagar') ?>"></input>
					</label>
				</div>
				<div class="col-lg-3">
					<label>Estado</label>
	...
	<div class="content-dashboard">
		<div class="franja-paginas">
			<div class="row">
				...
				<div class="col-lg-3 text-right text-end">
				...
				<tbody>
					<?php foreach ($this->lists as $content) { ?>
						...
						<tr>
							...
							<td><?= $content->pedido_valorpagar; ?></td>
