	...
	<form action="<?php echo $this->route; ?>" method="post">
		<div class="content-dashboard">
			<div class="row">
				...
				<div class="col-3">
					<label>&nbsp;</label>
					<a href="usuario/exportar?excel=1" class="btn btn-block btn-azul"> <i class="fas fa-download"></i> Exportar
						invitados Excel</a>
				</div>
			</div>
		</div>
...
<?php if ($_GET["res"] == 1 || $_GET["res"] == 2) { ?>
	<div class="modal fade" id="modalactivacion" tabindex="-1" role="dialog" aria-labelledby="popupLabel"
		aria-hidden="true">
				...
				<div class="modal-body pt-0">
					<?php if ($_GET["res"] == 1) { ?>
						...
						<div class="alert alert-success w-100 m-0" role="alert">
							<h4 class="alert-heading">¡Activación exitosa!</h4>
							<p>Hemos notificado al emprendedor que has activado su cuenta.</p>
						</div>
					...
					<?php if ($_GET["res"] == 2) { ?>
						...
						<div class="alert alert-warning w-100 m-0" role="alert">
							<h4 class="alert-heading">Activación exitosa</h4>
							<p>Has activado la cuenta del emprendedor, pero no hemos podido notificarle por correo electrónico.</p>
							<p>Por favor, asegúrate de que el correo electrónico del emprendedor sea correcto y envíale un mensaje manualmente.</p>
