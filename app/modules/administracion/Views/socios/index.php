			...
			<div class="row">
				<div class="col-3">
					...
					<label class="input-group">
						...
						<input type="text" class="form-control" name="socio_cedula" value="<?php echo $this->getObjectVariable($this->filters, 'socio_cedula') ?>"></input>
					</label>
				</div>
				<div class="col-3">
				...
				<div class="col-3">
					...
					<label class="input-group">
						...
						<input type="text" class="form-control" name="socio_nombre" value="<?php echo $this->getObjectVariable($this->filters, 'socio_nombre') ?>"></input>
					</label>
				</div>
				<div class="col-3">
					<label>Carnet</label>
					<label class="input-group">
						...
						<input type="text" class="form-control" name="socio_carnet" value="<?php echo $this->getObjectVariable($this->filters, 'socio_carnet') ?>"></input>
					</label>
				</div>
				<div class="col-3">
					<label>Correo</label>
					<label class="input-group">
						...
						<input type="text" class="form-control" name="socio_correo" value="<?php echo $this->getObjectVariable($this->filters, 'socio_correo') ?>"></input>
					</label>
				</div>
				<div class="col-3">
					<label>Celular</label>
					<label class="input-group">
						...
						<input type="text" class="form-control" name="socio_celular" value="<?php echo $this->getObjectVariable($this->filters, 'socio_celular') ?>"></input>
					</label>
				</div>
				<div class="col-3">
					<label>Activo</label>
					<label class="input-group">
						...
						<input type="text" class="form-control" name="socio_estado" value="<?php echo $this->getObjectVariable($this->filters, 'socio_estado') ?>"></input>
					</label>
				</div>
				<div class="col-3">
					<label>&nbsp;</label>
