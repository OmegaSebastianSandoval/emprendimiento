			...
			<table class=" table table-striped  table-hover table-administrator text-left">
				...
				<tbody>
					<?php foreach ($this->lists as $content) { ?>
						<?php $nombre_fichero = PUBLIC_PATH . 'images/' . $content->tiendas_imagen; ?>
						...
						?>
								...
								<tr>
									...
									<td>
										<?php
										$nombre_fichero = PUBLIC_PATH . 'images/' . $content->tiendas_imagen;
									...
									<td class="text-right text-end">
										<div>
											...
											<?php if ($_SESSION['kt_login_level'] == "1" or $_SESSION['kt_login_level'] == "3") { ?>
												<a class="btn btn-azul btn-sm" href="/administracion/tiendas/manage?id=<?= $id ?>" data-toggle="tooltip" data-placement="top" title="Editar"><i class="fas fa-pen"></i></a>
