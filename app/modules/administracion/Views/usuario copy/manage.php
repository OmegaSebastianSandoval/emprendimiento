		...
		<div class="content-dashboard">
			...
			<div class="row">
				...
				<div class="form-group col-md-6">
                    ...
                    <input type="number" class="form-control" value="<?= $this->content->user_telefono; ?>" id="telefono" name="telefono"  placeholder="">
                    <div class="help-block with-errors"></div>
                </div>
                <div class="form-group col-md-6">
                    <label for="accion">Número de Acción</label>
                    <input type="number" class="form-control" value ="<?= numeroaccion($this->content->user_accion); ?>"id="accion" name="accion"  placeholder="" data-error="Número de accion no valido"
