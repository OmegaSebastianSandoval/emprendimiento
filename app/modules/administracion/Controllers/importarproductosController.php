	...
	public function cargaAction()
	{
		...
		foreach ($infoexel as $fila) {
			...
			if($i>1){
				...
				$productos_cantidad_minima = $data['productos_cantidad_minima'] = $fila[I];
				$productos_limite_pedido = $data['productos_limite_pedido'] = $fila[J];
		...
		header("Location:/administracion/importarproductos/manage/?id=1&cargado=1");
	}
