...
class Administracion_Model_DbTable_Pedidos extends Db_Table
{
	...
	public function insert($data){
		...
		$query = "INSERT INTO pedidos( pedido_tipodocumento, pedido_documento, pedido_nombre, pedido_correo, pedido_telefono, pedido_celular, pedido_nomenclatura, pedido_direccion, pedido_ciudad, pedido_envio, pedido_medio, pedido_forma_envio, pedido_fecha, pedido_valorpagar, pedido_zona, pedido_estado, pedido_estado_texto, pedido_estado_texto2, pedido_cus, request_id) VALUES ( '$pedido_tipodocumento', '$pedido_documento', '$pedido_nombre', '$pedido_correo', '$pedido_telefono', '$pedido_celular', '$pedido_nomenclatura', '$pedido_direccion', '$pedido_ciudad', '$pedido_envio', '$pedido_medio', '$pedido_forma_envio', '$pedido_fecha', '$pedido_valorpagar', '$pedido_zona', '$pedido_estado', '$pedido_estado_texto', '$pedido_estado_texto2', '$pedido_cus', '$request_id')";
