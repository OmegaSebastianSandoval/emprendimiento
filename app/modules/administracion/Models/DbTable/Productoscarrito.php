...
class Administracion_Model_DbTable_Productoscarrito extends Db_Table
{
	...
	public function insert($data){
		...
		if ($id_productos!='') {
			echo $query = "INSERT INTO productos_carrito( id_carrito, id_productos, nombre, cantidad, valor, valor_iva) VALUES ( '$id_carrito', '$id_productos', '$nombre', '$cantidad', '$valor', '$valor_iva')";
