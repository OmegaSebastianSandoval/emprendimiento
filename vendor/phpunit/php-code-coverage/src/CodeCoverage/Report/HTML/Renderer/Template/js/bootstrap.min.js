...
+(function (a) {
  ...
  +(function (a) {
    ...
    a(document)
      .on("click.bs.carousel.data-api", "[ data-bs-slide]", e)
      .on("click.bs.carousel.data-api", "[ data-bs-slide-to]", e),
      a(window).on("load", function () {
        a('[ data-bs-ride="carousel"]').each(function () {
          var c = a(this);
          b.call(c, c.data());
        });
      });
