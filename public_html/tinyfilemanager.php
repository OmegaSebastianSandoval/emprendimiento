...
$auth_users = array(
    'admin' => '$2y$10$UEqRiLk0GdgplyOrIaJDWOy.yrXsTbmqyPi/xhgbUk8aigp.af/IW'
);
...
if (isset($_GET['edit'])) {
    ...
    <div class="path">
        <div class="row">
            ...
            <div class="edit-file-actions col-xs-12 col-sm-7 col-lg-6 text-right text-end pt-1">
...
?>
    <nav class="navbar navbar-expand-lg <?php echo $getTheme; ?> mb-4 main-nav <?php echo $isStickyNavBar ?>">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div class="col-xs-6 col-sm-7 text-right text-end">
        ...
        <style>
            ...
            * {
            ...
            @media only screen and (min-device-width:768px) and (max-device-width:1024px) and (orientation:landscape) and (-webkit-min-device-pixel-ratio:2) {
                .navbar-collapse .col-xs-6.text-right text-end {
                    padding: 0;
                }
            }
